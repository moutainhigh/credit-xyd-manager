 ...
 * 
 * @author zhangcong
 * @email zhangcong@champion-credit.com
 * @date 2020-02-29 15:05:36
 */
 
@Controller
@RequestMapping("/business/editor")
public class EditorController extends BaseController{
	...
	public Map<String, Object> imgUpload(HttpServletRequest request,HttpServletResponse response) 
		...
		while (item.hasNext()) {
		    ...
		    String imgUrl = savePath +newFileName;
		    //msg.put("url", imgUrl);
		    String str = getImageStr(imgUrl,request);
		    //截取‘/echartsExample/a/editor/’
		    //str = str.replace("/echartsExample/a/editor/","");
		    msg.put("url", "data:image/png;base64,"+str);
		    return msg;
		    }
			return null;
  }
	 ...
	 * @return
	 */
	public static String getImageStr(String imgFile, HttpServletRequest request) {
		if (StringUtils.isNotEmpty(imgFile)) {
			// imgFile = imgFile + "/test.png";
			InputStream in = null;
			byte[] data = null;
			try {
